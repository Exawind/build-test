...
if [ "${MACHINE}" == 'peregrine' ] || \
  ...
  (set -x; cp -R custom-package-files/py-rope ${SPACK_ROOT}/var/spack/repos/builtin/packages/)
  (set -x; cp -R custom-package-files/py-ipython ${SPACK_ROOT}/var/spack/repos/builtin/packages/)
  (set -x; cp -R custom-package-files/py-traitlets ${SPACK_ROOT}/var/spack/repos/builtin/packages/)
  ...
  (set -x; cp custom-package-files/openmpi/package.py ${SPACK_ROOT}/var/spack/repos/builtin/packages/openmpi/package.py)
