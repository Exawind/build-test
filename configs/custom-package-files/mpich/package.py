...
spack package at this time.''',
    ...
    def setup_environment(self, spack_env, run_env):
        spec = self.spec
        # mpich2 configure fails when F90 and F90FLAGS are set
        spack_env.unset('F90')
    ...
    def configure_args(self):
        ...
        config_args.append('--with-slurm-include=/nopt/slurm/current/include/slurm')
        config_args.append('--with-slurm-lib=/nopt/slurm/current/lib')
