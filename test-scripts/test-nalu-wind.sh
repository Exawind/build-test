...
main() {
  ...
  if [ "${MACHINE_NAME}" == 'rhodes' ]; then
    ...
    CONFIGURATIONS[2]='intel:18.0.4:false:develop:develop:develop:openfast;tioga;hypre'
    CONFIGURATIONS[3]='gcc:4.9.4:false:develop:develop:develop:openfast;tioga;hypre'
