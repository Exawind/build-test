...
class IntelParallelStudio(IntelPackage):
    ...
    version('cluster.2019.1',      'd4c249c5438c1a55640291efcc96418d', url='http://registrationcenter-download.intel.com/akdlm/irc_nas/tec/13589/parallel_studio_xe_2019_update1_cluster_edition.tgz')
