...
class Cgns(CMakePackage):
    ...
    def cmake_args(self):
        ...
        if '+hdf5' in spec:
            ...
            # Note CMake 3.6.1 does not set HDF5_IS_PARALLEL correctly
            # so CGNS will claim HDF5 isn't parallel and fail in that case
            # CMake 3.7.2 works correctly for example
            if '+parallel' in spec:
                options.extend([
