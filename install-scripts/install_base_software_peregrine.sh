...
do
  ...
  if [ ${COMPILER_NAME} == 'gcc' ]; then
    ...
    for PYTHON_VERSION in '2.7.14' '3.6.5'; do
      ...
      for PYTHON_LIBRARY in py-numpy py-matplotlib@2.0.2 py-pandas py-nose py-autopep8 py-flake8 py-jedi py-pip py-pyyaml py-rope py-seaborn py-sphinx py-yapf py-scipy py-yt; do
