...
#Script for installing Nalu-Wind on Eagle using Spack
#Make sure you have set SPACK_ROOT and run setup-spack.sh in this repo to obtain the recommended Spack preferences
