...
class Glib(AutotoolsPackage):
    ...
    url      = "https://ftp.gnome.org/pub/gnome/sources/glib/2.54/glib-2.54.1.tar.xz"

    version('2.54.1', 'f8903002421c44dc6e5b5baab8066f1f')
    version('2.54.0', '6e4db71816ccbc8dabf0e58fa7228e76')
